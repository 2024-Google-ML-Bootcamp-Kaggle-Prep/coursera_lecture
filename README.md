...
- **딥러닝 모델 최적화**: ![33%](https://progress-bar.dev/33)
...
- **신경망과 딥러닝**: ![100%](https://progress-bar.dev/30)
- **딥러닝 모델 최적화**: ![25%](https://progress-bar.dev/20)
- **머신러닝 프로젝트 구조화**: ![0%](https://progress-bar.dev/30)
- **합성곱 신경망**: ![0%](https://progress-bar.dev/15)
- **순차 모델**: ![0%](https://progress-bar.dev/5)
